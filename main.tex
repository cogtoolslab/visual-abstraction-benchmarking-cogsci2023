...
Human visual understanding is not unitary, but spans multiple levels of abstraction. 
For example, people know that real-world objects possess both distinctive features and features shared with other members of the same category. 
One of the most salient manifestations of this ability is in the domain of sketch comprehension: while one sketch may be evocative of a general category such as ``flower'' without resembling any particular flower, another sketch may faithfully depict a specific rose. 
To what degree are current vision algorithms sensitive to such variation in the degree of semantic abstraction expressed in sketches?

We measured a sketch’s \textit{genericity} by its ability to selectively evoke its target category but not strongly evoke any exemplar within that category; similarly, we measured a sketch’s \textit{specificity} as its ability to evoke the exemplar it was meant to depict but not other exemplars. Using these metrics and dataset
